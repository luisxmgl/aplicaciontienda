...
object Utils {
    fun getLogoForColegio(nombre: String): String {
        ...
        return when {
            ...
            normalized.contains("ITAHUE") -> "logo_colegioitahue"
            normalized.contains("KINGSTON") -> "logo_kingstoncollege"
            normalized.contains("PINARES") -> "logo_pinares"
            ...
            normalized.contains("CONCEPCION") || normalized.contains("VALDIVIA") -> "logo_concepcionpv"
            else -> ""
        }
    }
